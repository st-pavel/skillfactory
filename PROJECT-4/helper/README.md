# [Проект 6. Решение задачи классификации. Банковский кейс](https://github.com/st-pavel/project4/blob/main/Project_4_ML.ipynb)
...
### 3. Краткая информация о данных
- Данные принадлежат реальному банку - данные о последней маркетинговой кампании, которую проводил банк: задачей было привлечь клиентов для открытия депозита - расположены на [ресурсе](https://lms.skillfactory.ru/asset-v1:SkillFactory+DST-3.0+28FEB2021+type@asset+block@bank_fin.zip).
